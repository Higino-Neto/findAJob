...
export default function Questions({ questions, setQuestion }: QuestionsProps) {
              ...
              <div className="flex flex-col my-2 bg-gray-50 p-4 rounded-md">
                ...
                <div className="flex flex-col gap-3 mt-3 ml-3">
                  {question.options?.map((option, optionIndex) => (
                    <div key={optionIndex} className="flex gap-1 relative">
                      ...
                      <button
                        type="button"
                        onClick={() => deleteOption(optionIndex, questionIndex)}
